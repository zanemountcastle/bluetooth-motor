var MOTOR_SERVICE = 'FFF1';
var SWITCH_CHARACTERISTIC = 'FFF2';
var SPEED_CHARACTERISTIC = 'FFF3';
...
var app = {
    ...
    refreshDeviceList: function() {
        ...
        ble.scan([MOTOR_SERVICE], 5, app.onDiscoverDevice, app.onError);
    },
    ...
    setSpeed: function() {
        ...
        var success = function() {
            console.log('Set speed to ' + data[0]);
        };
